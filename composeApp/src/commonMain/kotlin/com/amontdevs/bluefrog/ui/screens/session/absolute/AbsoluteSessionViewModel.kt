...
class AbsoluteSessionViewModel(
    ...
    private fun setCurrentQuestion(progress: Float? = null) {
    ...
    private fun AbsoluteQuestion.questionNote() =
        when (this) {
    ...
    private fun AbsoluteQuestion.questionNotes() =
        when (this) {
